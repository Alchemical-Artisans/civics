<!--
  ...
  restated a table that is transcribed in full one click away, at 2027 Budget in
  Brief. So the figures moved into the wedges: hover one, or tab to it, and it
  says what it is and what it costs.
  ...
  walking them, and the transcription behind the link above carries every figure
  as text either way. Every wedge is focusable, which is also what makes the
